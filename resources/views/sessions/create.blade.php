                        ...
                        <div class="col-lg-4 col-md-8 col-12 mx-auto">
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <img src="/assets/img/logos/logobank.png" style='height: 100%; width: 100%; object-fit: contain'/>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}" class="text-start" id="login">
                                        @csrf
                                        ...
                                        <div class="form-check form-switch d-flex align-items-center my-3">
                                            ...
                                            <label class="form-check-label mb-0 ms-2" for="rememberMe">Lembre-me</label>
                                        </div>
